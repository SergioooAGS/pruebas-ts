namespace AppHolaMundo {
    ...
    export class P2 {
        ...
        offsetX = 0;
        offsetY = 0;
        //circulos: CirculoArray[] = [];
        mapa: Map<number, CirculoMap>;
        idC = 0;
        circleArr: CirculoArray[] = [];
        ...
        mapacircle(data: CirculoMap[]) {
            var mapa: Array<CirculoMap> = Array.from(this.mapa.values());
